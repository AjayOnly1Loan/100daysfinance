...
const RepayLoan = () => {
  return (
    <Box
      sx={{
        background: "white", // Right-to-left gradient
    ...
    >
      ...
      <Box
        sx={{
          position: "relative",
          width: "100%",
          height: { xs: "50vh", sm: "50vh", md: "100vh", lg: "100vh" }, // Responsive height
          overflow: "hidden",
          mb: 2,
        }}
      >
      ...
      >
        <strong style={{ color: "red" }}>Warning:</strong> We are not liable for
        any payments made in personal accounts of employees. Please make all
      ...
      >
        ...
        >
          ...
          >
            ...
            bank:
            <strong>recovery@100daysfinance.com</strong>.
          </Typography>
        </Box>
      </Box>
    </Box>
